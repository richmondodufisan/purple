...
#SBATCH --job-name=010_KCM_Mixed_Formulation  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --exclude=qnode0629,qnode0565,qnode0626,qnode0637


script_name="FDTR_input_KCM_Mixed_theta_0_freq_1e6_x0_0_v1.i"
