...
#SBATCH --job-name=05000_KCM_Mixed_Formulation  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --exclude=qnode0629,qnode0565,qnode0626,qnode0637


script_name="FDTR_input_KCM_Mixed_theta_0_freq_5e8_x0_0_v1.i"
