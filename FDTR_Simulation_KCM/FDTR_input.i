...
[BCs]
  ...
  []
  [interface_normal_condition]
    type = TemperatureFluxInterfaceBC
	variable = q_samp_z
	interface_conductance = ${interface_conductance_val}
	sample_temp = temp_samp
	transducer_temp = temp_trans
	boundary = 'boundary_conductance'
  []
  [flux_equivalence]
    type = MatchedValueNegativeBC
	variable = q_trans_z
	coupled_var = q_samp_z
	boundary = 'boundary_conductance'
  []
[]
