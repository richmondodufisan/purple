...
def calc_dispersion_relation_sym(thickness, density, poissons_ratio, shear_modulus, freq_min, freq_max, num_points):
    ...
    def D_cp(w, c_T, c_L, c_phase, h):
        ...
        term_1 = (cmath.tan(q * h)) / q
        term_2 = (4 * (k**2) * p) / ((((q**2) - (k**2))**2) *  (cmath.tan(p * h)))
