...
excitation_frequencies = ['1e3', '1.5e3', '2e3', '2.5e3', '3e3', '3.5e3', '4e3', '4.5e3', '5e3', '5.5e3', '6e3', '6.5e3', '7e3', '7.5e3', '8e3', '8.5e3', '9e3', '9.5e3', '10e3', '10.5e3', '11e3', '11.5e3', '12e3', '12.5e3', '13e3']  # Frequencies as strings for filename matching
file_template = 'Plate_Harmonic_Perturbation_freq_{freq}_out_wave_profile_*.csv'  # Stretch is fixed as '1'
