...
#SBATCH --mem-per-cpu=50M ## how much RAM do you need per CPU (this effects your FairShare score so be careful to not ask for more than you need))
#SBATCH --job-name=-3245_Fourier_Steady_Formulation  ## When you run squeue -u NETID this is how you can identify the job
