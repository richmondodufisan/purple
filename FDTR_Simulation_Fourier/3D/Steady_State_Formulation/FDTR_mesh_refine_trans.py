...
p27 = gmsh.model.occ.addPoint(xcen, ycen, trans_thick, trans_thick_ref/3)
p28 = gmsh.model.occ.addPoint(xcen, ycen+radius, trans_thick, pump_refine/3)
p29 = gmsh.model.occ.addPoint(xcen, ycen-radius, trans_thick, pump_refine/3)
p30 = gmsh.model.occ.addPoint(xcen+radius, ycen, trans_thick, pump_refine/3)
p31 = gmsh.model.occ.addPoint(xcen-radius, ycen, trans_thick, pump_refine/3)
...
p32 = gmsh.model.occ.addPoint(xcen, ycen+(radius/dummy_factor), trans_thick, trans_thick_ref/3)
p33 = gmsh.model.occ.addPoint(xcen, ycen-(radius/dummy_factor), trans_thick, trans_thick_ref/3)
p34 = gmsh.model.occ.addPoint(xcen+(radius/dummy_factor), ycen, trans_thick, trans_thick_ref/3)
p35 = gmsh.model.occ.addPoint(xcen-(radius/dummy_factor), ycen, trans_thick, trans_thick_ref/3)
