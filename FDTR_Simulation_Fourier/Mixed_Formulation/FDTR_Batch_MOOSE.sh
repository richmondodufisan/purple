...
#SBATCH --job-name=-110_Fourier_Mixed_Formulation  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --exclude=qnode0565,qnode0626,qnode0637,qnode0019,qnode0115,qnode1201


script_name="FDTR_input_Fourier_Mixed_theta_0_freq_1e6_x0_-1_v1.i"
