...
FDTR_data = pd.read_csv('FDTR_input_Traditional_out_1_um.csv', skiprows=1, names=['x0', 'frequency', 'imag_part', 'real_part'])
...
def fit_function_FDTR(freqs, G):
    ...
    for freq in freqs:
        # Define other parameters required by calc_thermal_response function
        N_layers = 3
        layer3 = [38.95e-6, 130, 130, 2329, 689.1]
        layer2 = [1.05e-6, 130, 130, 2329, 689.1]
        layer1 = [9e-8, 215, 215, 19300, 128.7]
