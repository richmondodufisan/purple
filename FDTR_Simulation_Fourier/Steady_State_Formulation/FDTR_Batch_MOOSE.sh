...
#SBATCH --job-name=010_Fourier_Steady_Formulation  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --exclude=qnode0565,qnode0626,qnode0637,qnode0019,qnode0115,qnode1201


script_name="FDTR_input_GibbsExcess_Interface_Fourier_Steady_theta_0_freq_1e6_x0_0.i"
