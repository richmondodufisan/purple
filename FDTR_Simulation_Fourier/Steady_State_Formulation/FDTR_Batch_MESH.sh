...
#SBATCH --job-name=create_mesh  ## When you run squeue -u NETID this is how you can identify the job
#SBATCH --output=create_mesh_log ## standard out and standard error goes to this file
