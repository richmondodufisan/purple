...
kappa_bulk_up_val = 130e-6
kappa_bulk_down_val = 100e-6
kappa_gb_val = 75.5e-6
...
[Functions]
  [grain_boundary_function]
    type = ParsedFunction
	expression = 'if ( (y > (slope * x) + (gb_width/2.0)), k_bulk_up, if ( (y < (slope * x) - (gb_width/2.0)), k_bulk_down, k_gb))'
	symbol_names = 'gb_width slope k_bulk_up k_bulk_down k_gb'
	symbol_values = '${gb_width_val} ${gb_slope_val} ${kappa_bulk_up_val} ${kappa_bulk_down_val}  ${kappa_gb_val}'
  []
  [angular_frequency]
	type = ParsedFunction
