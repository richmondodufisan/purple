...
[Materials]
  ...
  [strain_energy]
    type = ComputeStrainEnergyNeoHookeanIncompressible
    mu_0 = ${shear_modulus_val}
  []
  
  [intermediate_1]
    type = StressIntermediateIncompressible_1
	pressure = pressure
  []
  
  [intermediate_2]
    type = StressIntermediateIncompressible_2
  []

  [stress]
    type = ComputeStressIncompressible
  []
[]
