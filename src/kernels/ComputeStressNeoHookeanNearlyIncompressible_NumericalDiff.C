#include "ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff.h"
#include <Eigen/Dense>
#include <cmath>

registerMooseObject("purpleApp", ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff);

InputParameters
ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff::validParams()
{
...
ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff::ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff(const InputParameters & parameters)
...
void
ComputeStressNeoHookeanNearlyIncompressible_NumericalDiff::computeQpPK2Stress()
{
