#include "ConcreteGradientDamageMaterialLOCAL.h"
#include <Eigen/Dense>
#include <cmath>

registerMooseObject("purpleApp", ConcreteGradientDamageMaterialLOCAL);

InputParameters
ConcreteGradientDamageMaterialLOCAL::validParams()
{
...
ConcreteGradientDamageMaterialLOCAL::ConcreteGradientDamageMaterialLOCAL(const InputParameters & parameters)
...
void
ConcreteGradientDamageMaterialLOCAL::computeQpProperties()
{
	n_dim = 3;
