#include "HeatConductionSteadyImagAnisotropic.h"
#include "Material.h"
#include "MooseMesh.h"
...
registerMooseObject("purpleApp", HeatConductionSteadyImagAnisotropic);

InputParameters
HeatConductionSteadyImagAnisotropic::validParams()
{
...
HeatConductionSteadyImagAnisotropic::HeatConductionSteadyImagAnisotropic(const InputParameters & parameters)
...
ADReal
HeatConductionSteadyImagAnisotropic::computeQpResidual()
{
