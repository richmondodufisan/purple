#include "StressIncompressibilityConstraint.h"
#include "Material.h"
#include "MooseMesh.h"
...
registerMooseObject("purpleApp", StressIncompressibilityConstraint);

InputParameters
StressIncompressibilityConstraint::validParams()
{
...
StressIncompressibilityConstraint::StressIncompressibilityConstraint(const InputParameters & parameters)
