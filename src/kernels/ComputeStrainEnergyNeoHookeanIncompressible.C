#include "ComputeStrainEnergyNeoHookeanIncompressible.h"
#include <Eigen/Dense>
#include <cmath>

registerMooseObject("purpleApp", ComputeStrainEnergyNeoHookeanIncompressible);

InputParameters
ComputeStrainEnergyNeoHookeanIncompressible::validParams()
{
...
ComputeStrainEnergyNeoHookeanIncompressible::ComputeStrainEnergyNeoHookeanIncompressible(const InputParameters & parameters)
  : DerivativeMaterialInterface<Material>(parameters),
	...
	_dWdF(declarePropertyDerivative<RankTwoTensor>(_base_name + "strain_energy", _base_name + "deformation_gradient"))
