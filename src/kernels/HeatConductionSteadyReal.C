#include "HeatConductionSteadyReal.h"
#include "Material.h"
#include "MooseMesh.h"
...
registerMooseObject("purpleApp", HeatConductionSteadyReal);

InputParameters
HeatConductionSteadyReal::validParams()
{
...
HeatConductionSteadyReal::HeatConductionSteadyReal(const InputParameters & parameters)
...
ADReal
HeatConductionSteadyReal::computeQpResidual()
{
