...
protected:
  ...
  RankTwoTensor computePiolaKStress1(const Real &W, const Real &mu_0, const RankTwoTensor &F, const Real &p);
  RankTwoTensor compute_dWdF(const Real &mu_0, const RankTwoTensor &F);
  RankFourTensor compute_dPK1dF(const Real &W, const Real &mu_0, const RankTwoTensor &F, const Real &p);
  ...
  MaterialProperty<RankFourTensor> & _dPK1_dW;
};
