...
class ComputeStrainEnergyNeoHookeanNearlyIncompressible : public DerivativeMaterialInterface<ADMaterial>
{
public:
  static InputParameters validParams();

  ComputeStrainEnergyNeoHookeanNearlyIncompressible(const InputParameters & parameters);
