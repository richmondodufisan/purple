...
class ComputeStressIncompressibleNeoHookeanAugmented : public ComputeLagrangianStressPK2
{
public:
  static InputParameters validParams();
  ComputeStressIncompressibleNeoHookeanAugmented(const InputParameters & parameters);
